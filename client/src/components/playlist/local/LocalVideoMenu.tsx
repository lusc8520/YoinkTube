...
import {useDeleteLocalVideo, useEditLocalVideo} from "../../../hooks/playlist/LocalPlaylists.ts"
import EditIcon from "@mui/icons-material/Edit"
import CheckIcon from "@mui/icons-material/Check"
import CloseIcon from "@mui/icons-material/Close"

export function LocalVideoMenu({video} : {video: VideoDto}) {
    ...
    const {mutate: deleteVideo} = useDeleteLocalVideo()
    const {mutate: editVideo}  = useEditLocalVideo()
