...
export function LocalPlaylistDetailsMenu({setDialog} : Props) {
        ...
        <>
            ...
            <PopperMenu handleClose={close} anchor={anchor.current} isOpen={isOpen}>
                <MenuItem
                    onClick={() => {
                        setOpen(false)
                        setDialog(<AddLocalVideoDialog onCancel={() => setDialog(null)}/>)
                    }}
                    sx={menuItemStyle}>
                    <AddIcon/>
                    Add Video
                ...
                <MenuItem
                    onClick={() => {
                        setOpen(false)
                        setDialog(<EditLocalPlaylistDialog onCancel={() => setDialog(null)}/>)
                    }}
                    sx={menuItemStyle}>
                ...
                <MenuItem
                    onClick={_=> {
                        setOpen(false)
                        setDialog(<DeleteLocalPlaylistDialog onCancel={() => setDialog(null)}/>)
                    }}
                    sx={menuItemStyle}>
